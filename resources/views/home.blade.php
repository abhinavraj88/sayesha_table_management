...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/images/sayesha.jpg') }}">
    <link href="https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;500;600;700&display=swap" rel="stylesheet">

    <title>Sayesha Restro and Cafe</title>
<!--
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>Nestled in the heart of the city, Sayesha redefines fine dining with an 
                            experience that transcends the ordinary. Every dish at Sayesha tells a story, 
                            crafted with precision and passion by our world-class chefs who masterfully 
                            blend authentic flavors with contemporary elegance.</p>
                        <p>Step into Sayesha and indulge in an ambiance where luxury meets comfort, and 
                            the artful design echoes our commitment to quality and sophistication. Perfect 
                            for both intimate gatherings and grand celebrations, Sayesha ensures that every 
                            moment is a feast for the senses, making it not just a meal, but a memorable journey in taste and refinement.</p>
                        <div class="row">
                            <div class="col-4">
            ...
            <div class="row">
                <div class="col-lg-4 col-xs-12">
                    <div class="right-text-content">
                            <ul class="social-icons">
                                <li><a href="https://www.facebook.com/sayeshaa.cafe?mibextid=LQQJ4d"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://www.instagram.com/sayeshaa.cafe?igsh=MzJyZ2s3eHQ0ajA1"><i class="fa fa-instagram"></i></a></li>
                            </ul>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="logo">
                        <a href="{{url('home')}}"><img src="{{ asset('assets/images/klassy-logo.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-12">
                    <div class="left-text-content">
                        <p>© Copyright Sayesha Restro & and Cafe Co.</p>
                    </div>
                </div>
            </div>
        </div>
